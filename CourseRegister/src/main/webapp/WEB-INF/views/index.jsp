...
<head>
    ...
    <link href="/CourseRegister/css/index.css" rel="stylesheet">
     <script src="/CourseRegister/js/index.js"></script>
...
<body class="login" >
    ...
    <div class="wrap-login">
        <div class="wrap-login-wrap">
            <div class="login-box">
                <form action="/CourseRegister/login" method="post" autoComplete="off" id="loginForm" onsubmit="return validateForm()">
                    <div class="wrap-lang">                    
